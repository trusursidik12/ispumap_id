<link rel='stylesheet' href='<?= base_url(); ?>/css/main-style.css' type='text/css' media='all' />
...
<section class="hero-area" id="home">
    <div class="hero-slides owl-carousel">
        <?php foreach ($header_provinces as $key => $province) : ?>
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img slide-background-overlay" style="background-image: url(<?= base_url(); ?>/img/header/slide_<?= str_replace(" ", "_", $province["name"]); ?>.png);">
                    ...
                    <div class="row h-100 align-items-end">
                        <div class="col-12">
                            <div class="awesome-weather-wrap awecf awe_wide temp7 awe_with_stats awe-code-802 awe-desc-scattered-clouds" style=" color: #ffffff; ">
                                <div class="row">
                                    <div class="col-12" style="font-size:16px;font-weight:bolder;display: flex;">
                                        <img style="height:30px;width:30px;" src="<?= base_url(); ?>/img/ic_emote_<?= str_replace(" ", "_", strtolower($province["category"])); ?>.png">&nbsp;&nbsp;
                            ...
                            <div class="awesome-weather-wrap awecf awe_wide temp7 awe_with_stats awe-code-802 awe-desc-scattered-clouds" style="<?= ($_this->is_mobile()) ? "display:none;" : ""; ?>color: #ffffff; ">
                                ...
                                <div class="row">
                                    <div class="col-2"><img style="height:30px;width:40px;" src="<?= base_url(); ?>/img/wind_direction.png"></div>
                                    <div class="col-3 btn"><?= ($province["data"]->wd) ? $province["data"]->wd : "0"; ?> &#176;</div>
                                    <div class="col-1"></div>
                                    <div class="col-2"><img style="height:30px;width:40px;" src="<?= base_url(); ?>/img/wind_speed.png"></div>
                                    <div class="col-3 btn"><?= ($province["data"]->ws) ? $province["data"]->ws : "0"; ?> Km/h</div>
                                    <div class="col-1"></div>
                                </div>
                                <div class="row">
                                    <div class="col-2"><img style="height:30px;width:40px;" src="<?= base_url(); ?>/img/humidity.png"></div>
                                    <div class="col-3 btn"><?= ($province["data"]->humidity) ? $province["data"]->humidity : "0"; ?> %</div>
                                    <div class="col-1"></div>
                                    <div class="col-2"><img style="height:30px;width:40px;" src="<?= base_url(); ?>/img/rain_rate.png"></div>
                                    <div class="col-3 btn"><?= ($province["data"]->rain_intensity) ? $province["data"]->rain_intensity : "0"; ?> mm/jam</div>
                                    <div class="col-1"></div>
                                </div>
                                <div class="row">
                                    <div class="col-2"><img style="height:30px;width:40px;" src="<?= base_url(); ?>/img/solar_radiation.png"></div>
